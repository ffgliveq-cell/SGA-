...
local function C_T(p, t, y, cb)
    ...
    b.BackgroundColor3 = Color3.fromRGB(100, 40, 40) b.Text = "تعطيل ❌" b.TextColor3 = Color3.fromRGB(255, 255, 255) b.TextSize = 12 b.Font = Enum.Font.SourceSansBold table.insert(TglB, b)
